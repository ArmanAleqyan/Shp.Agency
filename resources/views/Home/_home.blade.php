...
<main >
    ...
    <div class="content">
        ...
        <div class="about js-mask-holder">
            ...
            <h1 class="js-animation" >

                    <span class="about_title-line" >

                        <span class="about_title-text"><strong>

                             @if($generaltitleArr[0]){{$generaltitleArr[0]}} @else  @endif  </strong>
                           @if($generaltitleArr[1]){{$generaltitleArr[1]}} @else   @endif</span>
                    </span>

                <span class="about_title-line" >
                        <span class="about_title-text" style="word-break: break-all;">
                         @if($generaltitleArr[2])   {{$generaltitleArr[2]}} @else   @endif<strong>
                           @if ($generaltitleArr[3])    {{$generaltitleArr[3]}} @else  @endif
                            </strong>
            ...
            <div class="services_holder">
                <div class="services_item">
                    <div class="service service__red  js-animation">
                        ...
                        <div class="service_text" style="word-break: break-all;">
                            <ul style="max-width: 100%; height: auto">
                                @if($line1)
...
{{--                    </style>--}}
               ...
               @if($photoTeam1)
                <div class="team_member" >
                    ...
                    <div class="team_member-tooltip">
                        <span class="team_member-title">{{$name1}}<br></span>
                        <span class="team_member-description">{{$textTeam1}}<br></span>
                    </div>
                    @endif
             @if($photoTeam2)
                </div>
                <div class="team_member">
                    ...
                    <div class="team_member-tooltip">
                        <span class="team_member-title">{{$name2}}<br></span>
                        <span class="team_member-description">{{$textTeam2}}<br></span>
                    </div>
                </div>
                @endif
                @if($photoTeam3)
                <div class="team_member" >
                    ...
                    <div class="team_member-tooltip">
                        <span class="team_member-title">{{$name3}}<br></span>
                        <span class="team_member-description">{{$textTeam3}}<br></span>
                    </div>
                </div>
                   @endif
                   @if($photoTeam4)
                <div class="team_member" >
                    ...
                    <div class="team_member-tooltip">
                        <span class="team_member-title">{{$name4}}<br></span>
                        <span class="team_member-description">{{$textTeam4}}<br></span>
                    </div>
                </div>
                   @endif
                   @if($photoTeam5)
                <div class="team_member">
                    ...
                    <div class="team_member-tooltip">
                        <span class="team_member-title">{{$name5}}<br></span>
                        <span class="team_member-description">{{$textTeam5}}<br></span>
                    </div>
                </div>
                   @endif
                   @if($photoTeam6)
                <div class="team_member">
                    ...
                    <div class="team_member-tooltip">
                        <span class="team_member-title">{{$name6}}<br></span>
                        <span class="team_member-description">{{$textTeam6}}<br></span>
                    </div>
                </div>
                   @endif
                   @if($photoTeam7)
                <div class="team_member" >
                    ...
                    <div class="team_member-tooltip">
                        <span class="team_member-title">{{$name7}}<br></span>
                        <span class="team_member-description">{{$textTeam7}}<br></span>
                    </div>
                </div>
                   @endif
            </div>
        ...
        <div id="{{str_replace(' ','_',$menu[4]->name)}}" class="careers" style="word-break: break-all;">
            @foreach($job as $jobs)
                @if($job)
                ...
                <div class="footer_column">
                    <div class="footer_subcolumn">
                        ...
                        <a target="_blank" href=" http://maps.google.com/?q={{$address}}">
                            <div style="    width: 100%;  max-width: 182px;">
                              {{$address}}
                            </div>
                        </a>
                            @endif
    ...
    <div class="popup_content">
        ...
        <form  method="POST" class="contact-form form1">
            ...
            <p class="contact-form_text">
                ...
                <br>
                <span style=" display: flex; justify-content: center; color: #ff6547 ; font-size: 18px;text-decoration: none;margin-right: 50px;" id="erroremail"></span>
            </p>
        ...
        <form method="post"  class="contact-form"  enctype="multipart/form-data">
            ...
            <p class="contact-form_text">
             ...
             <a class="js-file-upload-link" href="">{{$cv2[24]}} {{$cv2[25]}} {{$cv2[26]}}</a>
               ...
               <br>
                <br>
                 <span style="font-size: 36px; display: flex;justify-content: center; color:#ff6547; padding-bottom: 10px;  font-size: 18px;
    text-decoration: none;
    margin-right: 96px;" id="error"></span>
            </p>
            <div style=" display: flex; flex-direction: column;align-items: center;justify-content: center; font-size: 18px;
    text-decoration: none;
    margin-right: 50px;">
