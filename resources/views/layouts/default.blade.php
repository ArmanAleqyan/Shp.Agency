...
<div class="container-scroller">
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
            ...
            <a class="sidebar-brand brand-logo" style="color: white; text-decoration: none;" href="{{route('adminhome')}}">
                SHP
            </a>
...
{{--                    <a href="#" id="profile-dropdown" data-toggle="dropdown"><i class="mdi mdi-dots-vertical"></i></a>--}}
            ...
            <li class="nav-item menu-items">
                <a class="nav-link" href="{{route('contentmenu')}}">
              <span class="menu-icon">
                <i class="mdi mdi-speedometer"></i>
              </span>
                    <span class="menu-title">Пункты меню</span>
                </a>
            </li>

            <li class="nav-item menu-items">
                <a class="nav-link" href="{{route('contentemail')}}">
              <span class="menu-icon">
                <i class="mdi mdi-speedometer"></i>
              </span>
                    <span class="menu-title">Email для заявок</span>
                </a>
            </li>

            <li class="nav-item menu-items">
                <a class="nav-link" href="{{route('contentheader')}}">
              <span class="menu-icon">
                <i class="mdi mdi-speedometer"></i>
              </span>
            ...
            <li class="nav-item menu-items">
                <a class="nav-link" href="{{route('contenttwo')}}">
              <span class="menu-icon">
                <i class="mdi mdi-speedometer"></i>
              </span>
            ...
            <li class="nav-item menu-items">
                <a class="nav-link" href="{{route('contentthree')}}">
              <span class="menu-icon">
                <i class="mdi mdi-speedometer"></i>
              </span>
            ...
            <li class="nav-item menu-items">
                <a class="nav-link" href="{{route('contentfor')}}">
              <span class="menu-icon">
                <i class="mdi mdi-speedometer"></i>
              </span>
                    <span class="menu-title">Логотипы партнеров</span>
                </a>
            </li>
            <li class="nav-item menu-items">
                <a class="nav-link" href="{{route('eventcontent')}}">
              <span class="menu-icon">
                <i class="mdi mdi-speedometer"></i>
              </span>
...
{{--            <li class="nav-item menu-items">--}}
{{--                <a class="nav-link" href="{{route('contentseven')}}">--}}
{{--              <span class="menu-icon">--}}
{{--                <i class="mdi mdi-speedometer"></i>--}}
{{--              </span>--}}
{{--                    <span class="menu-title">Контент  Baker </span>--}}
{{--                </a>--}}
{{--            </li>--}}

            <li class="nav-item menu-items">
                <a class="nav-link" href="{{route('contentnine')}}">
              <span class="menu-icon">
                <i class="mdi mdi-speedometer"></i>
              </span>
                    <span class="menu-title">Команда</span>
                </a>
            </li>
            <li class="nav-item menu-items">
                <a class="nav-link" href="{{route('contentjobs')}}">
              <span class="menu-icon">
                <i class="mdi mdi-speedometer"></i>
              </span>
            ...
            <li class="nav-item menu-items">
                <a class="nav-link" href="{{route('contentfooter')}}">
              <span class="menu-icon">
                <i class="mdi mdi-speedometer"></i>
              </span>
            ...
            <li class="nav-item menu-items">
                <a class="nav-link" href="{{route('formcontactus')}}">
              <span class="menu-icon">
                <i class="mdi mdi-speedometer"></i>
              </span>
                    <span class="menu-title">Формы</span>
                </a>
            </li>
...
<script>
$(document).on('blur','.ql-editor',function () {
    var content = $('.ql-editor').html();
    $('#quill_html').val(content);
})
</script>
